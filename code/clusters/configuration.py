...
elbow_start = cluster["elbow_start"]
elbow_stop = cluster["elbow_stop"]
elbow_step = cluster["elbow_step"]
...
do_plot_extrapolation = visualization["do_plot_extrapolation"]
move_coeff = visualization["move_coeff"]
...
extr_stop = extrapolation_dict["extr_stop"]
extr_step = extrapolation_dict["extr_step"]